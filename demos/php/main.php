...
$settings = new ItsmeSettings($client_id, $redirect_url, $private_jwk_set);
$client = new Client($settings);
$config = new UrlConfiguration(['profile', 'email'], 'my_service_code', '');
$itsme_auth_url = $client->GetAuthenticationUrl($config);
print_r ($itsme_auth_url);
$user = $client->GetUserDetails('code');
print_r ($user);
